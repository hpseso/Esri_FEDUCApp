    ...
    extends AreaMap
{
    ...
    public static AreaMap_.IntentBuilder_ intent(Context context) {
        return new AreaMap_.IntentBuilder_(context);
    }
    ...
    public void loadPOIonMap(final FeatureSet fset, final Envelope env) {
        handler_.post(new Runnable() {
            ...
            public void run() {
                try {
                    AreaMap_.super.loadPOIonMap(fset, env);
                } catch (RuntimeException e) {
                    Log.e("AreaMap_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, AreaMap_.class);
        }
        ...
        public AreaMap_.IntentBuilder_ flags(int flags) {
